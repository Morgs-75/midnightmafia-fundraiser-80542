                  ...
                  {showContent && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="mt-4 pb-2"
                      >
                        <p className="text-purple-200 text-xs mb-2 font-semibold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                          📱 Share Your Support
                        </p>
                        <div className="flex gap-2 justify-center flex-wrap">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-11 h-11 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Instagram"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-11 h-11 bg-blue-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Facebook"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-11 h-11 bg-black rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Twitter/X"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-11 h-11 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="WhatsApp"
                          >
                          ...
                          <motion.button
                            ...
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-11 h-11 bg-gray-700 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
                            title="Copy Link"
                          >
